			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarsFurni">
					...
					<ul class="custom-navbar-cta navbar-nav mb-2 mb-md-0 ms-5">
						<li><a class="nav-link" href="uProfile.php"><img src="../Assets/Templates/Main/images/user.svg"></a></li>
						<li><a class="nav-link" href="MYCart.php"><img src="../Assets/Templates/Main/images/cart.svg"></a></li>
					</ul>
				</div>
			</div>
