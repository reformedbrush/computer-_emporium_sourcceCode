		...
		<div class="why-choose-section">
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-6">
						...
						<div class="row my-5">
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="Assets/Templates/Main/images/truck.svg" alt="Image" class="imf-fluid">
									</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="Assets/Templates/Main/images/bag.svg" alt="Image" class="imf-fluid">
									</div>
									<h3>Easy to Shop</h3>
									<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.</p>
								</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="Assets/Templates/Main/images/support.svg" alt="Image" class="imf-fluid">
									</div>
									<h3>24/7 Support</h3>
									<p>Donec vitae odio quis nisl dapibus malesuada. Nullam ac aliquet velit. Aliquam vulputate.</p>
								</div>
							...
							<div class="col-6 col-md-6">
								<div class="feature">
									<div class="icon">
										<img src="Assets/Templates/Main/images/return.svg" alt="Image" class="imf-fluid">
									</div>
					...
					<div class="col-lg-5">
						<div class="img-wrap">
							<img src="Assets/Templates/Main/images/img1.jpg" alt="Image" class="img-fluid">
						</div>
					</div>
			...
			<div class="container">
				<div class="row justify-content-between">
					<div class="col-lg-7 mb-5 mb-lg-0">
						<div class="imgs-grid">
							<div class="grid grid-1"><img src=".\Assets\Templates\Main\images\grid2.jpg" alt="Untree.co"></div>
							<div class="grid grid-2"><img src=".\Assets\Templates\Main\images\grid4.jpg" alt="Untree.co"></div>
							<div class="grid grid-3"><img src=".\Assets\Templates\Main\images\pexels-amar-20108031.jpg" alt="Untree.co"></div>
						</div>
					</div>
